...
<Nota>
  ¿Quieres ver qué se automatiza en tu sector? En el{" "}
  <Link href="/#sectores">selector de la portada</Link> están los casos concretos de comercio,
  salud, servicios profesionales, veterinarias, logística y oficios.
</Nota>
