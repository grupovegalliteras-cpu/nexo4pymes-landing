...
<nav aria-label="Ruta de navegación" className="font-mono text-[11px] uppercase tracking-[0.12em] text-suave">
  <Link href="/" className="text-teal">Inicio</Link> › <Link href="/blog" className="text-teal">Blog</Link> › Por qué diagnosticar antes de automatizar
</nav>

<p className="mt-6 font-mono text-[11px] uppercase tracking-[0.14em] text-teal">Diagnóstico previo · 5 min de lectura</p>

# Por qué automatizar sin diagnosticar antes puede hundirte el negocio

<p className="mt-6 border-l-2 border-coral pl-5 text-[18px] leading-relaxed text-bottle">
...
<Nota>
  ...
  solo para eso: <Link href="/veterinarias">automatización para clínicas veterinarias</Link>.
</Nota>
