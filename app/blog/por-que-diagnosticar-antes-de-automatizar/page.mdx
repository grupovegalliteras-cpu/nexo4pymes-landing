...
<Nota>
  ¿Tienes una clínica veterinaria? Es el sector que mejor conocemos y tenemos una página hecha
  solo para eso: <Link href="/">automatización para clínicas veterinarias</Link>.
</Nota>
