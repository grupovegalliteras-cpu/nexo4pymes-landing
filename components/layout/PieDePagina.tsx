...
/* Pie común a las dos páginas. `cruce` es el enlace entre ellas:
   la portada manda a veterinarias y la landing devuelve a la portada,
   con anchor descriptivo (ayuda a posicionar cada una en lo suyo). */
...
export function PieDePagina({
  ...
  return (
    <footer className="oscuro relative overflow-hidden bg-bottle-900 px-5 pb-10 pt-16 text-white sm:px-8">
      ...
      <div className="relative mx-auto max-w-[1120px]">
        ...
        <div className="flex flex-col gap-2 rounded-2xl border border-white/10 bg-white/[.03] p-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href={cruce.href}
            className="group inline-flex items-center gap-2 text-[14.5px] font-medium text-mint"
          >
            {cruce.texto}
        ...
        <div className="mt-12 grid gap-10 sm:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-[42ch] text-[14px] leading-relaxed text-white/55">
              Agencia de automatización de procesos con inteligencia artificial para pymes y
              autónomos. Diagnóstico primero, implementación por fases después.
            </p>
            ...
            {redes && (
              <div className="mt-5 flex gap-3">
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-white/70 transition-colors hover:border-mint/50 hover:text-mint"
                >
