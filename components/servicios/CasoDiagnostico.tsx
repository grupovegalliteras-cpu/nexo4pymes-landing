...
export function CasoDiagnostico() {
  return (
    <Seccion id="caso" tono="oscuro" ancho="ancho">
      <Reveal>
        <div className="relative overflow-hidden rounded-panel border border-white/9 bg-gradient-to-br from-white/[.06] to-white/[.015] p-8 shadow-[0_30px_80px_rgba(0,0,0,.45),inset_0_1px_0_rgba(255,255,255,.1)] backdrop-blur-xl sm:p-12">
          <div
            aria-hidden="true"
